...
class TransformTrainWeakStrong(object):
    def __init__(self,resize_size=256, crop_size=224, mean=imagenet_mean, std=imagenet_std):
...
class TransformTrainWeakStrongStrong(object):
    def __init__(self,resize_size=256, crop_size=224, mean=imagenet_mean, std=imagenet_std):
        self.weak = transforms.Compose([
            ResizeImage(resize_size),
            transforms.RandomResizedCrop(crop_size),
    ...
    def __call__(self, x):
        return self.normalize(self.weak(x)), self.normalize(self.strong(x)), self.normalize(self.strong(x))


class TransformVisWeakStrong(object):
    def __init__(self,resize_size=256, crop_size=224, mean=imagenet_mean, std=imagenet_std):
        self.weak = transforms.Compose([
...
class TransformTrainCifarWeakStrong(object):
    def __init__(self, mean, std, crop_size=224):
        self.weak = transforms.Compose([
            transforms.RandomHorizontalFlip(),
            transforms.RandomCrop(size=32,
...
class TransformTrainCifarWeakStrongStrong(object):
    def __init__(self, mean, std, crop_size=224):
        self.weak = transforms.Compose([
            transforms.RandomHorizontalFlip(),
            transforms.RandomCrop(size=32,
